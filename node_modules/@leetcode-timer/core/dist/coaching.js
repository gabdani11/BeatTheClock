 ...
 */
export function getCustomCoachingMessages(durationSeconds) {
    const percentMap = [
 ...
 */
export function getCustomPhases(durationSeconds) {
 ...
 */
export function getCoachingMessage(difficulty, elapsedSeconds, durationSeconds) {
